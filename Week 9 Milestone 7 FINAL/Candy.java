...
public class Candy extends Snack {
    ...
    Candy(String name, String brand, double price, String type, String flavor,
          double weight, double sugar, int calories, String image, int quantity, String productID) {
    ...
    public String toString() {
        return String.format("%-15s%-15s%-15.2f%-12s%-12s%-12.2f%-12d%-12.2f%-12d%-12s", name, brand, price, type, flavor,
                weight, calories, sugar, quantity, productID);
    }
