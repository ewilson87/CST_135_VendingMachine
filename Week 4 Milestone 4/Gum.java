...
public class Gum extends Snack {
	...
	Gum(String name, String brand, double price, String flavor, double weight,
		int pieces, Boolean sugarFree, int calories, Boolean whitening, String image)
	{
		super.setName(name); 
	...
	protected void setFlavor(String flavor) { this.flavor = flavor; }
	...
	public int getCalories() { return super.getCalories();}
	...
	public String toString() {
		return String.format("%-15s%-15s%-12.2f%-12d%-12s%-12.2f%-12b%-12d%-12b", brand, name, price, pieces, flavor,
				weight, sugarFree, calories, whitening);
	}
}
