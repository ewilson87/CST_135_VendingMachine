...
public class Drink extends Product implements Comparable<Drink> {
    ...
    Drink(String name, String brand, double price, double size, int calories,
          double sugar, Boolean caffeine, Boolean healthy, String image, int quantity) {
    ...
    public String toString() {
        return String.format("%-10s%-20s%-12.2f%-12.2f%-12d%-12.2f%-12b%-12b", brand, name, price, size,
                calories, sugar, caffeine, healthy);
    }
